...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.lat_lng_layout = QGridLayout()
    ...
    def _create_gps_buttons(self):
        ...
        latitudeButton1 = QPushButton("Set Latitude Point 1", self)
        latitudeButton1.clicked.connect(self.getLatitude)
        latitudeButton1.setFont(QFont('Times', 11))

        #creating longitude input text box
        longitudeButton1 = QPushButton("Set Longitude Point 1", self)
        longitudeButton1.clicked.connect(self.getLongitude)
        longitudeButton1.setFont(QFont('Times', 11))

        latitudeButton2 = QPushButton("Set Latitude Point 2", self)
        latitudeButton2.clicked.connect(self.getLatitude)
        latitudeButton2.setFont(QFont('Times', 11))

        #creating longitude input text box
        longitudeButton2 = QPushButton("Set Longitude Point 2", self)
        longitudeButton2.clicked.connect(self.getLongitude)
        longitudeButton2.setFont(QFont('Times', 11))

        self.lat_lng_layout.addWidget(latitudeButton1)
        self.lat_lng_layout.addWidget(longitudeButton1)

        self.lat_lng_layout.addWidget(latitudeButton2)
        self.lat_lng_layout.addWidget(longitudeButton2)
